...
### İlk Loglar
<div class="mb mt" style="text-align:center"><img src="/img/kibana/kibana_1.png" /></div>  
...
<div class="mb mt" style="text-align:center"><img src="/img/kibana/kibana_2.png" /></div>  
...
curl --user elastic:{PASS} -XPUT -H 'Content-Type: application/json' http://localhost:9200/_template/auditbeat-7.12.0 -d@auditbeat.template.json
```  
...
<div class="mb mt" style="text-align:center"><img src="/img/kibana/kibana_3.png" /></div>  

İkinci adımda "@timestamp" seçilir ve index oluşturulur.  

<div class="mb mt" style="text-align:center"><img src="/img/kibana/kibana_4.png" /></div>  

Bu işlemin ardından artık linux sisteme ait logları sol menüden "Security" -> "Overview" altından görüntüleyebilirsiniz.

<div class="mb mt" style="text-align:center"><img src="/img/kibana/kibana_5.png" /></div>  
